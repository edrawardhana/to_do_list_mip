...
Menambahkan File kode CameraModal.jsx, yaitu mempersiapkan fitur open camera menggunakan sdk supabase
Membuat service upload untuk mengirim ke supabase storage
Menyiapkan logika validasi waktu agar tombol kamera hanya aktif dijam tertentu. sepakatnya akan dibuka dalam 24 jam hari itu juga. Jika sudah lewat harinya tombol kamera akan disabled
